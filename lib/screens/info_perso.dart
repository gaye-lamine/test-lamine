...
class _InfoPersoState extends State<InfoPerso> {
  ...
  /* void updateActivateState() {
    bool isActive =
        addressController.text.isNotEmpty && nomController.text.isNotEmpty ;
    setState(() {
      isactive = isActive;
    });
  } */
  ...
  void updateActivateState() {
    ...
    if (!switchValue) {
      // If the switch is off, activate button when nom and address are filled
      isActive =
          nomController.text.isNotEmpty && addressController.text.isNotEmpty;
    } else {
      // If the switch is on, activate button when carteController is filled
